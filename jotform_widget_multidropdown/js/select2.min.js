!(function (n) {
    ...
    ((e = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : e) && e.requirejs) ||
        ...
        e.define("select2/results", ["jquery", "./utils"], function (u, d) {
            ...
            return (
                ...
                (s.prototype.render = function () {
                    var e = u('<ul class="select2-results__options" aria-label="Options" role="listbox"></ul>');
                ...
                (s.prototype.option = function (e) {
                    ...
                    for (t in (((null != e.element && i.call(e.element, ":disabled")) || (null == e.element && e.disabled)) &&
                        ((s["aria-disabled"] = "true"), n.classList.remove("select2-results__option--selectable"), n.classList.add("select2-results__option--disabled")),
                    ...
                    this.$results.attr("id", n),
                        ...
                        t.on("results:previous", function () {
                            ...
                            s <= 0 ||
                                ...
                                0 === s ? i.$results.scrollTop(0) : t - n < 0 && i.$results.scrollTop(e));
                        }),
                        t.on("results:next", function () {
                            ...
                            n >= s.length ||
                                ...
                                0 === n ? i.$results.scrollTop(0) : e < s && i.$results.scrollTop(t));
                        }),
        ...
        e.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function (e, t, n, s) {
            ...
            return (
                ...
                (i.prototype.update = function (e) {
                    ...
                    0 === e.length
                        ? this.clear()
                        : ((e = e[0]), (t = this.$selection.find(".select2-selection__rendered")), (n = this.display(e, t)), t.empty().append(n), (n = e.title || e.text) ? t.attr("title", n) : t.removeAttr("title"));
                }),
                i
            );
        }),
        ...
        e.define(
            ...
            function (l, o, r, a, c, u, d, p, h, f, g, t, m, y, v, _, b, $, w, x, A, D, S, O, E, C, L, T, q, I, e) {
                function n() {
                    this.reset();
                }
                return (
